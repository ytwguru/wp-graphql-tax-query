<?php
/**
 * Plugin Name: WPGraphQL Tax Query - YT Advisors Edited
...
class TaxQuery {
    ...
    public function register_types( $type_name) {
        ...
        $this->type_registry->register_enum_type( $type_name . 'TaxQueryField', [
        ...
        $this->type_registry->register_enum_type( $type_name . 'TaxQueryOperator', [
            'values' => [
                'IN'         => [
                    'name'  => 'IN',
                    'value' => 'IN',
        ...
        $this->type_registry->register_input_type( $type_name . 'TaxArray', [
            'fields' => [
                'taxonomy'        => [
                    'type' => 'TaxonomyEnum',
                ],
        ...
        $this->type_registry->register_input_type( $type_name . 'TaxQuery', [
...
add_action( 'graphql_register_types', function( TypeRegistry $type_registry ) {
    return new TaxQuery($type_registry);
} );
